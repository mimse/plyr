...
var controls = {
    ...
    createHiddenLabel: function createHiddenLabel(type, attr) {
...
var defaults$1 = {
    ...
    'play',
    // 'fast-forward',
    'progress', 'current-time', 'mute', 'volume', 'captions', 'settings', 'pip', 'airplay', 'fullscreen', 'live'],
...
var Plyr = function () {
    function Plyr(target, options) {
        ...
        if (this.config.debug) {
            on.call(this.elements.container, this.config.events.join(' '), function (event) {
                _this.debug.log('event: ' + event.type, event);
            });
        }
